...
/**
 * Convenience hook, stronger version of useMatch, that enables to match multiple patterns against current pathname
 ...
 */
export default function useMatchEither(patterns) {
